 ...
 */
declare const InternalEventEmitter: new <EventsMap>() => InterfaceEventEmitter<EventsMap>;
/**
 ...
 * InterfaceEventEmitter.
 */
declare class EventEmitter<EventsMap> extends InternalEventEmitter<EventsMap> {
}
