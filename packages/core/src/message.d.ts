...
export declare class DefaultMessage implements Message {
    ...
    constructor(serial: string, clientId: string, roomId: string, text: string, metadata: MessageMetadata, headers: MessageHeaders, action: ChatMessageActions, version: string, createdAt: Date, timestamp: Date, operation?: Operation | undefined);
    get isUpdated(): boolean;
    get isDeleted(): boolean;
    get updatedBy(): string | undefined;
    get deletedBy(): string | undefined;
