...
describe('ChatRoomProvider', () => {
  ...
  it('should keep room attached when one of multiple providers is hidden', async () => {
    ...
    const { rerender } = render(<TestComponent show1={true} show2={true} />);
    ...
    rerender(<TestComponent show1={false} show2={true} />);
    ...
    rerender(<TestComponent show1={false} show2={false} />);
  ...
  it('should handle options changes', async () => {
    ...
    const { rerender } = render(
      <ChatClientProvider client={chatClient}>
        <ChatRoomProvider name={roomName} options={initialOptions}>
    ...
    rerender(
      <ChatClientProvider client={chatClient}>
        <ChatRoomProvider name={roomName} options={newOptions}>
