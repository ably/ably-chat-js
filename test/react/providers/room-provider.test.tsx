...
import { RoomProvider } from '../../../src/react/providers/room-provider.tsx';
...
describe('RoomProvider', () => {
  ...
  it('it should correctly release rooms', () => {
    const chatClient = newChatClient() as unknown as ChatClient;
    const TestComponent = () => {
      return <div />;
    };
  ...
  it('it should attach and detach correctly', () => {
    const chatClient = newChatClient() as unknown as ChatClient;
    const TestComponent = () => {
      return <div />;
    };
  ...
  it('it should not attach, detach, or release when not configured to do so', () => {
    const chatClient = newChatClient() as unknown as ChatClient;
    const TestComponent = () => {
      return <div />;
    };
