...
import { useRoomReactions } from '../../../src/react/hooks/use-occupancy.ts';
...
describe('useRoomReactions', () => {
  ...
  it('it should provide the room reactions instance and correct chat status response metrics', () => {
    ...
    // check connection and room metrics are correct provided
  ...
  it('it should correctly call the room reactions send method', async () => {
    const { result } = renderHook(() => useRoomReactions());
  ...
  it('it should correctly subscribe and unsubscribe to reactions', () => {
  ...
  it('it should handle rerender if the room instance changes', () => {
  ...
  it('it should subscribe and unsubscribe to discontinuity events', () => {
    const mockOff = vi.fn();
