...
export class DefaultConnection extends EventEmitter<ConnectionEventsMap> implements Connection {
  private _status: ConnectionStatus = ConnectionStatus.Initialised;
