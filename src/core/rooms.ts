...
export interface Rooms {
   ...
   * import { ChatClient } from '@ably/chat';
   *
   * const chatClient = new ChatClient(realtime, { logLevel: 'debug' });
   *
   * console.log('Chat client log level:', chatClient.rooms.clientOptions.logLevel);
   * // Output: Chat client log level: debug
   * ```
   */
