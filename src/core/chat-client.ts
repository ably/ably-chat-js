...
export class ChatClient {
  ...
  constructor(realtime: Ably.Realtime, clientOptions?: ChatClientOptions) {
    ...
    this._clientIdResolver = new DefaultClientIdResolver(this.connection, realtime, this._logger);
    this._rooms = new DefaultRooms(realtime, this._clientOptions, this._clientIdResolver, this._logger);
  ...
  async dispose(): Promise<void> {
    ...
    // Dispose of the clientId resolver
    this._clientIdResolver.dispose();
