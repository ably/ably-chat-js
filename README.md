...
First, make sure you've installed the Chat SDK using the instructions above. Now, create a `.ts` file with the following code.
...
publishChatMessage().catch(console.error);
```
